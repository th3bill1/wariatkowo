    ...
    <main className="login-page">
      <section className="login-card" aria-labelledby="login-title">
        ...
        <div>
          ...
          <h1 id="login-title">
            {selected ? "Wpisz PIN" : "Kto wrócił do Wariatkowa?"}
          </h1>
          <p className="login-card__description">
            {selected
              ? "Cztery cyfry i jesteśmy w domu."
              : "Wybierz swój profil."}
          </p>
        </div>
        {!selected ? (
          ...
          <form className="pin-form" onSubmit={submit}>
            <div className="pin-form__member">
              <ProfileAvatar member={selected} />
            ...
            <label className="field">
              ...
              <input
                autoFocus
                className="field__input pin-input"
                inputMode="numeric"
                maxLength={4}
                pattern="\d{4}"
                required
