...
const statements = Object.entries(pins)
  .map(([memberId, pin]) => {
...
console.log(
  "PIN hashes updated for both household members. Existing sessions were revoked.",
);
